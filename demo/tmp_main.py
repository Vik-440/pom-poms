...
def return_data_from_sql(data_start_order, data_end_order):
    ...
    log_pass_sql = 'postgresql+psycopg2://tcjukcve:vUJC-YJ0isoZ5NvtvvtiBjD75n-vaqfJ@hattie.db.elephantsql.com/tcjukcve'
    ...
    for row in id_order_1:      # робочий 2 яруси отримання данних
        ...
        #     j_quantity_pars_model.append(row1.quantity_pars_model)
