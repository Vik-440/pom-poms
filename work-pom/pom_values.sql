...
surname__client, id_sity, np_number, id_team, coach)
VALUES
	(11, 381111111111, 'Козинець', 'Олена', 'Василівна', 21, 111, 	31, FALSE),
	(12, 382222222222, 'Коробенко','Ольга',	'Вячеславівна',	22, 112, 32, FALSE),
    (13, 383333333333, 'Гаврушко', 'Ліля', 'Остапівна',	23,	113, 33, TRUE),
    (14, 384444444444, 'Тимошенко',	'Світлана',	'Петрівна',	25,	114, 34, FALSE),
    (15, 385555555555, 'Блажко', 'Наталія', 'Андріївна', 24, 115,	35,	FALSE);
...
INSERT INTO directory_of_color (id_color, name_color, kod_kolor, width_color, thickness_color,
bab_quantity_color, bab_weight_color, weight_color, manufacturer_color, reserve_color, weight_10m_color)
VALUES
    (61, 'Срібний_гол', 45, 23, 30, 6, 130, 3045, 'Rovno',0 , 12.67),
    (62, 'Червоний', 70, 23, 36, 4, 130, 1256, 'Rovno',0 , 11.8),
    (63, 'Бірюзовий', 73, 22, 36, 2, 130, 1672, 'Rovno',0 , 10.29),
    (64, 'Білий', 77, 25, 36, 11, 130, 14034, 'Rovno',0 , 11.15),
    (65, 'Рожевий', 78, 23, 30, 3, 130, 2005, 'Rovno',0 , 9.64),
    (66, 'Синій', 80, 23, 36, 2, 130, 1893, 'Rovno',0 , 12.78),
    (67, 'Малиновий', 'B05', 660, 35, 4, 40, 40, 'Itak',0 ,0), 
    (68, 'Синій', 'B09', 660, 35, 0, 0, 0, 'Itak',0 ,0), 
    (69, 'Бірюзовий', 'B21', 660, 35, 1, 10, 10, 'Itak',0 ,0);
